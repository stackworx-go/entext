...
func (e UserEdges) StatusesOrErr() ([]*UserStatus, error) {
	if e.loadedTypes[0] {
...
func (*User) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldID, user.FieldCreatedByID, user.FieldUpdatedByID:
...
func (u *User) QueryStatuses() *UserStatusQuery {
	return (&UserClient{config: u.config}).QueryStatuses(u)
}
...
func (u *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", u.CreatedByID))
	builder.WriteString(", updated_at=")
	builder.WriteString(u.UpdatedAt.Format(time.ANSIC))
	builder.WriteString(", updated_by_id=")
	builder.WriteString(fmt.Sprintf("%v", u.UpdatedByID))
