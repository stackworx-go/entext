...
func (uq *UserQuery) QueryStatuses() *UserStatusQuery {
...
func (uq *UserQuery) WithStatuses(opts ...func(*UserStatusQuery)) *UserQuery {
	query := &UserStatusQuery{config: uq.config}
...
func (uq *UserQuery) sqlAll(ctx context.Context) ([]*User, error) {
	...
	if query := uq.withStatuses; query != nil {
		...
		for i := range nodes {
			...
			nodes[i].Edges.Statuses = []*UserStatus{}
		}
		query.Where(predicate.UserStatus(func(s *sql.Selector) {
			s.Where(sql.InValues(user.StatusesColumn, fks...))
		}))
